            ...
            with gr.Tab(label='Advanced'):
                ...
                with gr.Column(visible=modules.config.default_developer_debug_mode_checkbox) as dev_tools:
                    ...
                    with gr.Tab(label='FreeU'):
                        ...
                        freeu_b1 = gr.Slider(label='B1', minimum=0, maximum=2, step=0.01, value=1.0)
                        freeu_b2 = gr.Slider(label='B2', minimum=0, maximum=2, step=0.01, value=1.0)
                        freeu_s1 = gr.Slider(label='S1', minimum=0, maximum=4, step=0.01, value=1.0)
                        freeu_s2 = gr.Slider(label='S2', minimum=0, maximum=4, step=0.01, value=1.0)
